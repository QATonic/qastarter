...
export default function ProgressBar({ 
  ...
  return (
    ...
    >
      ...
      <div className="relative -mx-4 px-4 md:mx-0 md:px-0" role="progressbar" aria-valuenow={progressPercentage} aria-valuemin={0} aria-valuemax={100}>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  {isCompleted ? (
                    <CheckCircle className="w-5 h-5 animate-in zoom-in duration-200" aria-hidden="true" />
                  ) : (
                    <span className={cn(
                      "font-bold",
        ...
        <div 
          className="absolute top-4 left-4 right-4 -z-10 hidden md:block" 
          aria-hidden="true"
        >
