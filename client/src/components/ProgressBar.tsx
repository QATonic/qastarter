                ...
                >
                  <button
                    className={cn(
                      ...
                      isCompleted
                        ? 'bg-gradient-to-br from-emerald-500 to-teal-500 text-white border-transparent shadow-lg shadow-emerald-500/30'
                        : isCurrent
                          ? 'bg-gradient-to-br from-emerald-500 to-teal-500 text-white border-transparent shadow-lg shadow-emerald-500/30 motion-safe:animate-pulse'
                          : 'bg-muted text-muted-foreground border-muted',
                      isClickable
                        ? 'cursor-pointer hover:scale-110 hover:shadow-xl hover:shadow-emerald-500/40 hover-elevate'
                        : 'cursor-default'
                    )}
                  ...
                  >
                    {isCompleted ? (
                      ...
                      <span
                        className={cn('font-bold', isCurrent ? 'motion-safe:animate-pulse' : '')}
                      >
                        {index + 1}
                      </span>
                    )}
