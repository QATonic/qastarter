  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        {mobileView ? (
          <Button
            ...
            aria-label="Support the QAStarter project"
          >
          ...
          <Button
            variant="outline"
            size="sm"
            className={`gap-1.5 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 dark:from-emerald-500 dark:to-teal-500 text-white dark:text-white border-emerald-500 dark:border-emerald-500 font-medium whitespace-nowrap ${triggerClassName}`}
      ...
      <DialogContent className="sm:max-w-lg p-0 gap-0 overflow-hidden">
        {/* Header */}
        <DialogHeader className="p-6 pb-4 bg-gradient-to-r from-emerald-500/5 to-teal-500/5 border-b">
            ...
            <div className="md:pr-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  aria-label="Support via Buy Me a Coffee (opens in new tab)"
                  className="inline-flex items-center justify-center w-full gap-2 rounded-md px-4 py-2 text-sm font-semibold bg-[#FFDD00] hover:bg-[#FFDD00]/90 text-black shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                >
                  <svg
                    className="h-5 w-5"
                    viewBox="0 0 24 24"
