          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <RadioGroupItem value="" id="cicd-none" className="sr-only" />
                <Label htmlFor="cicd-none" className="text-sm font-medium cursor-pointer">
                  None (Skip CI/CD)
                </Label>
              </div>
              <p className="text-xs text-muted-foreground mt-1">Configure CI/CD later manually</p>
            </div>
            {!config.cicdTool && <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0" />}
          </div>
