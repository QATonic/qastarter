...
export const ErrorMessages = {
  ...
  GENERATION_FAILED:
    'Failed to generate your project. This might be due to an invalid configuration or server issue.',
  GENERATION_TIMEOUT:
    'Project generation is taking longer than expected. Please try again with a simpler configuration.',
  DOWNLOAD_FAILED: 'Failed to download the project file. Please try generating it again.',

  // Configuration errors
  INVALID_CONFIG:
    'Your configuration contains invalid values. Please review your selections and try again.',
  MISSING_REQUIRED: 'Some required fields are missing. Please complete all required steps.',
  INCOMPATIBLE_OPTIONS:
    'The selected options are not compatible with each other. Please review your choices.',

  // Dependencies errors
  DEPENDENCIES_LOAD_FAILED:
    'Failed to load project dependencies. Dependencies will be configured during generation.',
  DEPENDENCIES_INVALID:
    'Unable to resolve dependencies for your configuration. Please check your selections.',

  // Storage errors
  STORAGE_FULL:
    "Your browser's storage is full. Please clear some space or use a different browser.",
  STORAGE_UNAVAILABLE: 'Browser storage is not available. Some features may not work properly.',

  // Template errors
  TEMPLATE_NOT_FOUND:
    'The requested template pack could not be found. Please select different options.',
