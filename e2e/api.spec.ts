...
test.describe("QAStarter API", () => {
  ...
  test("POST /api/generate-project with invalid config should return error", async ({ request }) => {
    const response = await request.post("/api/generate-project", {
      data: {
        testingType: "invalid",
        framework: "invalid",
  ...
  test("GET /api/v1/generate should generate project via query params", async ({ request }) => {
    const response = await request.get("/api/v1/generate?projectName=cli-test&testingType=web&framework=selenium&language=java&buildTool=maven&testRunner=testng&testingPattern=pom");
    expect(response.ok()).toBeTruthy();
  ...
  test("POST /api/generate-project with missing required fields should return validation error", async ({ request }) => {
    const response = await request.post("/api/generate-project", {
      data: {
  ...
  test("POST /api/generate-project with special characters in project name should be sanitized", async ({ request }) => {
    const response = await request.post("/api/generate-project", {
      data: {
        testingType: "web",
        framework: "selenium",
  ...
  test("POST /api/validate-config with incompatible framework/language combo", async ({ request }) => {
  ...
  test("POST /api/project-preview with valid Java config should return Maven structure", async ({ request }) => {
    const response = await request.post("/api/project-preview", {
      data: {
        testingType: "web",
        framework: "selenium",
  ...
  test("POST /api/generate-project with utilities should include utility files", async ({ request }) => {
    const response = await request.post("/api/generate-project", {
      data: {
        testingType: "web",
        framework: "selenium",
  ...
  test("GET /api/v1/config/filters should return framework compatibility info", async ({ request }) => {
  ...
  test("POST /api/generate-project with very long project name should handle gracefully", async ({ request }) => {
  ...
  test("POST /api/generate-project with empty project name should return error", async ({ request }) => {
    const response = await request.post("/api/generate-project", {
      data: {
        testingType: "web",
        framework: "selenium",
