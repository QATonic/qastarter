// DEPRECATED: Use scripts/validate-all-packs.ts instead
  ...
  for (const type of validationMatrix.testingTypes) {
    ...
    for (const framework of validFrameworks) {
      ...
      for (const language of validLanguages) {
        ...
        if (
          validationMatrix.frameworkLanguageTestRunners &&
          validationMatrix.frameworkLanguageTestRunners[specificRunnersKey]
        ) {
        ...
        if (
          validationMatrix.frameworkLanguageBuildTools &&
          validationMatrix.frameworkLanguageBuildTools[specificRunnersKey]
        ) {
