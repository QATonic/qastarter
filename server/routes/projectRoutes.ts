 ...
 */
router.post('/generate-project', generateProjectLimiter, asyncHandler(async (req, res) => {
 ...
 */
router.post('/project-dependencies', asyncHandler(async (req, res) => {
 ...
 */
router.post('/project-preview', asyncHandler(async (req, res) => {
 ...
 */
router.get('/v1/generate', generateProjectLimiter, asyncHandler(async (req, res) => {
