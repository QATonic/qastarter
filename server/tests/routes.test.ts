...
function createTestApp(): Express {
  ...
  app.get('/api/v1/metadata', (req, res) => {
    const metadata = {
      ...
      testRunners: Object.entries(validationLabels.testRunners).map(([id, label]) => ({
        id,
        label,
      })),
...
describe('API Routes', () => {
  ...
  describe('GET /api/v1/metadata', () => {
    it('should return metadata with all available options', async () => {
      const response = await request(app).get('/api/v1/metadata').expect(200);
  ...
  describe('GET /api/v1/config/options', () => {
    it('should return wizard configuration options', async () => {
      const response = await request(app).get('/api/v1/config/options').expect(200);
  ...
  describe('GET /api/v1/config/filters', () => {
    it('should return filter rules for wizard', async () => {
      const response = await request(app).get('/api/v1/config/filters').expect(200);
  ...
  describe('GET /api/analytics/stats', () => {
    it('should return analytics statistics', async () => {
      const response = await request(app).get('/api/analytics/stats').expect(200);
  ...
  describe('GET /api/analytics/session', () => {
    it('should return a new session ID', async () => {
      const response = await request(app).get('/api/analytics/session').expect(200);
  ...
  describe('GET /api/v1/health/cache', () => {
    it('should return cache health status', async () => {
      const response = await request(app).get('/api/v1/health/cache').expect(200);
